...
export default function ProjectGallery({ photos, projectTitle }: Props) {
  ...
  // Lightbox slides — use the same URLs since Next.js will serve optimized
  // versions via Image at the grid level. Lightbox shows the original.
        ...
        {photos.map((photo, i) => (
          <li key={photo.url} className="relative">
            <button
              ...
              className="group block w-full overflow-hidden bg-linen aspect-[4/5] relative cursor-zoom-in"
